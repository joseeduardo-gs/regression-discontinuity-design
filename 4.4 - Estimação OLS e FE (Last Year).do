*****************************************************************************************
*                ANÁLISE EMPÍRICA - REGRESSÕES OLS e FE (LAST YEAR)
****************************************************************************************
...
xtreg log_despesa_geral_pc partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_1

xtreg log_despesa_geral_pib partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_2

xtreg log_total_receitas_pc partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_3

xtreg log_total_receitas_pib partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_4

xtreg log_receita_tributaria_pc partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_5

xtreg log_receita_tributaria_pib partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_6

xtreg log_servidores_comissionados_mil partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_7

xtreg educacao_prop partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_8

xtreg saude_prop partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_9

xtreg assistencia_social_prop partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_10

xtreg urbanismo_prop partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_11

xtreg transporte_prop partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_12

xtreg desporto_e_lazer_prop partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_13

xtreg seguranca_publica_prop partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
estimates store fe_conditional_14

xtreg gestao_ambiental_prop partido_de_esquerda pop pib_pc i.id_mandato, fe vce(cluster cod_municipio_ibge)
